...
const requests = {
    ...
    fetchRomanceMovies: `${base_url}/discover/movie?${api}&with_genres=18`,
    ...
    .then((data) => {
        ...
        data.results.forEach((movie, index) => {
            ...
            if (index < 15) {     
                ...
                const button = document.createElement("div");
                button.classList.add('row-col', 'mb-1');
                button.innerHTML = `<button type="button" class="row__button btn btn-light" data-bs-toggle="modal" data-bs-target="#exampleModal">
                </button>`;
                row_posters.appendChild(button)
            }
        });
